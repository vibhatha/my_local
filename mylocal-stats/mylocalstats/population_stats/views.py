...
from mylocalstats.population_stats.models import Region, TotalPopulation, AgeDistribution, EthnicityDistribution
from mylocalstats.population_stats.serializers import RegionSerializer, TotalPopulationSerializer, AgeDistributionSerializer, EthnicityDistributionSerializer
