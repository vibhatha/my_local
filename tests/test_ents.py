...
def test_district_for_province(neo4j_driver):
    ...
    for result in neo4j_results:
        ...
        print(f"Province: {province_name} (ID: {province_id}) - " f"Districts: {', '.join(neo4j_district_names)}")
...
def test_dsd_per_district(neo4j_driver):
    ...
    for result in neo4j_results:
        ...
        print(f"District: {district_name} (ID: {district_id}) - " f"DSDs: {', '.join(neo4j_dsd_names)}")
...
def test_ed_for_province(neo4j_driver):
    ...
    for result in neo4j_results:
        ...
        print(f"Province: {province_name} (ID: {province_id}) - " f"Electoral Districts: {', '.join(neo4j_ed_names)}")
...
def test_lg_per_district(neo4j_driver):
    ...
    for result in neo4j_results:
        ...
        print(f"District: {district_name} (ID: {district_id}) - " f"Local Governments: {', '.join(neo4j_lg_names)}")
...
def test_lg_for_province(neo4j_driver):
    ...
    for result in neo4j_results:
        ...
        neo4j_lg_names = sorted([f"{d['name']} ({d['id']})" for d in result["lgs"]])
        print(f"Province: {province_name} (ID: {province_id}) - " f"Local Governments: {', '.join(neo4j_lg_names)}")
...
def test_dsd_for_province(neo4j_driver):
    ...
    for result in neo4j_results:
        ...
        neo4j_dsd_names = sorted([f"{d['name']} ({d['id']})" for d in result["dsds"]])
        print(f"Province: {province_name} (ID: {province_id}) - " f"DSDs: {', '.join(neo4j_dsd_names)}")
...
def test_dsd_per_ed(neo4j_driver):
    ...
    for result in neo4j_results:
        ...
        assert (
            ed_id in eds_per_province[province_id]
        ...
        neo4j_dsd_names = sorted([f"{d['name']} ({d['id']})" for d in result["dsds"]])
        print(
            f"Province: {province_name} (ID: {province_id}) - "
...
def test_moh_per_district(neo4j_driver):
    ...
    for result in neo4j_results:
        ...
        print(f"District: {district_name} (ID: {district_id}) - " f"MOH Areas: {', '.join(neo4j_moh_names)}")
...
def test_pd_per_ed(neo4j_driver):
    ...
    for result in neo4j_results:
        ...
        print(f"Electoral District: {ed_name} (ID: {ed_id}) - " f"Polling Divisions: {', '.join(neo4j_pd_names)}")
